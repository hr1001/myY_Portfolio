...
const imageMetadata = {
  profile1: {
    url: "/profile.jpg",
    alt: "Suguru Yamamoto - Senior Full Stack Developer Professional Photo",
    width: 800,
    height: 800,
  },
  profile2: {
    url: "/profile.jpg",
    alt: "Suguru Yamamoto - Senior Full Stack Developer Profile Photo",
    width: 800,
    height: 800,
  },
};
        ...
        <script
          ...
          dangerouslySetInnerHTML={{
            __html: JSON.stringify({
              ...
              image: [
                `https://github.com/sgryjp${imageMetadata.profile1.url}`,
                `https://github.com/sgryjp${imageMetadata.profile2.url}`,
              ],
              jobTitle: "Senior Full Stack Developer",
              description:
                "Senior Full Stack Developer with 7+ years of experience in enterprise applications, AI integration, and cloud platforms.",
            }),
          }}
        />
      </Head>
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              Senior Full Stack Developer | AI Integration Lead
            </motion.p>
            ...
            >
              I architect enterprise-scale applications and integrate AI solutions that drive business value. 
              With 7+ years of experience at companies like Fujitsu, Rakuten, and NEC, I specialize in 
              building scalable systems, mentoring developers, and delivering solutions that make a real impact.
            </motion.p>
            ...
            >
              ...
              >
                ...
                <div className="flex gap-2">
                  <div
                    ...
                    className="relative w-[100px] overflow-hidden rounded-md"
                  >
                    <div className="absolute inset-0">
                    ...
                    <button
                      ...
                      className="relative z-10 w-full px-4 py-[6px] flex items-center justify-center gap-1 text-xs md:text-sm"
                    >
                  ...
                  <div
                    id="home-download-button-wrapper"
                    className="relative w-[100px] overflow-hidden rounded-md"
                  >
                    <div className="absolute inset-0">
                      <div className="absolute inset-0 bg-gradient-to-r from-green-500 via-emerald-500 to-green-500 animate-gradient-xy" />
                    </div>
                    <div className="absolute inset-[2px] bg-[#2a2a2a] rounded-[4px]" />
                    <a
                      href="/Suguru-Yamamoto_real.pdf"
                      download="Suguru_Yamamoto_Resume.pdf"
                      className="relative z-10 w-full px-4 py-[6px] flex items-center justify-center gap-1 text-xs md:text-sm"
                    >
              ...
              >
                ...
                <a
                  href="https://www.linkedin.com/in/suguru-yamamoto-4a8032165"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="text-gray-400 hover:text-blue-500 transition-all duration-300 hover:scale-125 hover:-rotate-12"
                >
