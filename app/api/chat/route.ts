      ...
      const response = await fetch(
        "https://openrouter.ai/api/v1/chat/completions",
        {
          ...
          headers: {
            ...
            "HTTP-Referer": "https://github.com/sgryjp",
            "X-Title": "Suguru's Portfolio",
    ...
    linkedin_link: [
      {
        ...
        url: "https://linkedin.com/in/suguru-yamamoto-4a8032165",
  ...
  try {
    ...
    async function callModel(state: typeof MessagesAnnotation.State) {
      try {
        ...
        let systemContent = `You are Suguru Yamamoto, a Senior Full Stack Developer with 9 years of experience in backend and full-stack development and AI model integration.`;
        ...
        systemContent += `\n\nRules:
        1. Speak as Suguru using "I" and "my"
